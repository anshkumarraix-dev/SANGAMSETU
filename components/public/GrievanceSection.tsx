  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 py-8">
      ...
      <div className="relative w-full h-44 sm:h-52 md:h-60 rounded-2xl overflow-hidden mb-6 border border-slate-200 shadow-sm bg-slate-900">
        <Image
          src="/images/banner-cpgrams.jpg"
          alt="Public grievance redressal, institutional mediation and administrative support"
          fill
          loading="lazy"
